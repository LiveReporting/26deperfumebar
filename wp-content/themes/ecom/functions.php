...
function my_scripts_method() {
    wp_register_script('custom_script', get_template_directory_uri().'/js/jssor.core.js', array('jquery'));
    wp_enqueue_script('custom_script');
    wp_register_script('custom_script1', get_template_directory_uri().'/js/jssor.utils.js', array('jquery'));
    wp_enqueue_script('custom_script1');
    wp_register_script('custom_script2', get_template_directory_uri().'/js/jssor.slider.js', array('jquery'));
    wp_enqueue_script('custom_script2');
    wp_register_script('custom_script5', get_template_directory_uri().'/js/default.js', array('jquery'));
    wp_enqueue_script('custom_script5');
    if(is_page('create-your-own-perfume-one')) {
        wp_register_script('custom_script4', get_template_directory_uri().'/js/form.js', array('jquery'));
        wp_enqueue_script('custom_script4');
    }
    if(is_page('home')) {
        wp_register_script('custom_script3', get_template_directory_uri().'/js/slider.js', array('jquery'));
